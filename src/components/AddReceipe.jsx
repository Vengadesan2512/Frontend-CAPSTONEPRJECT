...
//formik
  ...
  //         ist: Yup.string().required('Instruction is required'),
  //         ing1: Yup.string().required('Ingridients is required'),
  //         ing2: Yup.string().required('Ingridients is required'),
  //         ing3: Yup.string().required('Ingridients is required'),
  //         ing4: Yup.string().required('Ingridients is required'),
  //         qty1: Yup.string().required('Quantity is required'),
  //         qty2: Yup.string().required('Quantity is required'),
  //         qty3: Yup.string().required('Quantity is required'),
  //         qty4: Yup.string().required('Quantity is required'),
  //         imgUrl: Yup.string().required('Quantity is required'),
